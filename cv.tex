...
\begin {document}
		...
		\begin {tabular} {c}
			...
			\\
				\begin {tabular} {rl}
					...
					\textbf {Address:} & 7 Methonis Str., Flat 202, \\
							& 2064 Strovolos, Cyprus \\
	...
	\section* {Employment}
		\begin {description}
            ...
            aims to offer business software solutions.  As the company was in
	...
	\section* {Code Samples / Released Software}
        Code samples can be found at \url{https://github.com/gtzampanakis}.
