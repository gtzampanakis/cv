...
\begin {document}
	...
	\section* {Employment}
		\begin {description}
            ...
            \item [August 2015--now:] \landmark{Senior Software Engineer} at
            \company{Wargaming.net} in Ni\-co\-si\-a, Cyprus. Sole responsible
            for design, development, testing, deployment and monitoring of
            multiple crucial backend financial systems. Main technologies:
            ...
            automation. My role was the only software development resource of
            the billing team. Main technologies: Python, Oracle Database.
	...
	\section* {Webapps}
		\begin {description}
            ...
            uses a user's answer history to pick problems close to her/his
